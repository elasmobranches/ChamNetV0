...
custom_hooks = [
    dict(
        check_finite=True,
        min_delta=0.0001,
        monitor='depth/abs_rel',
        patience=20,
        rule='less',
        type='EarlyStoppingHook'),
    dict(log_interval=100, type='MTLWeightLoggerHook'),
    dict(flush_secs=10, out_csv=None, type='MTLIterLoggerHook'),
]
custom_imports = dict(
...
work_dir = '/workspace/mmsegmentation/work_dirs/chamnet_mtl_manual_1_5_last_ch128_int'
